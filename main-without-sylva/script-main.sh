...
curl https://raw.githubusercontent.com/Kristian-ZH/m3-one-click-demo/main/main-without-sylva/equinix-playbook-main.yaml > ~/ansible/equinix-playbook.yaml

#put the extra vars file in the ansible directory temporarily
curl https://raw.githubusercontent.com/Kristian-ZH/m3-one-click-demo/main/main-without-sylva/extra_vars_main.yml > ~/ansible/extra_vars.yml
